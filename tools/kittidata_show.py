...
def pcd2bin(pcdfolder, binfolder):
    ...
    for file in file_list: 
        ...
        print("velodyne_file_new:   ", velodyne_file_new)
        pl.tofile(velodyne_file_new)


# 直接输入绝对地址
def pcd2bin2(pcdfolder, binfolder):
...
if __name__ == '__main__':
    main()
#     pcd2bin2("/mnt/why/act/record/pcd_data/frontleft","/mnt/github_demo/OpenPCDet/frontlidar")